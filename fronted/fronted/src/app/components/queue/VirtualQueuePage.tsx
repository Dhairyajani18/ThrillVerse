...
const DEFAULT_RIDES = [
  ...
  { id: 6, name: "Splash Ahoy!", emoji: "💦", category: "water", thrill_level: 3, capacity: 16, duration: "4 min", zone: "Zone B", height: "100 cm", rating: 4.60, current_wait_time: 0, total_queue_count: 0, status_label: "Open (0 min wait)", img: dinoImg },
  { id: 7, name: "Gold Rush Express", emoji: "🚂", category: "family", thrill_level: 2, capacity: 30, duration: "5 min", zone: "Zone C", height: "90 cm", rating: 4.40, current_wait_time: 0, total_queue_count: 0, status_label: "Open (0 min wait)", img: nitroImg },
  { id: 8, name: "Alibaba Aur Chalis Chorr", emoji: "🕌", category: "family", thrill_level: 2, capacity: 50, duration: "8 min", zone: "Zone C", height: "80 cm", rating: 4.50, current_wait_time: 0, total_queue_count: 0, status_label: "Open (0 min wait)", img: screamImg },
  { id: 9, name: "Bhangarh: The Curse", emoji: "👻", category: "family", thrill_level: 2, capacity: 40, duration: "8 min", zone: "Zone C", height: "None", rating: 4.50, current_wait_time: 0, total_queue_count: 0, status_label: "Open (0 min wait)", img: spacexImg },
  { id: 10, name: "Chai Spin Chaos", emoji: "☕", category: "family", thrill_level: 1, capacity: 36, duration: "5 min", zone: "Zone C", height: "None", rating: 4.30, current_wait_time: 0, total_queue_count: 0, status_label: "Open (0 min wait)", img: dropImg },
  { id: 11, name: "Wrath of the Gods", emoji: "🔥", category: "family", thrill_level: 3, capacity: 50, duration: "15 min", zone: "Zone C", height: "100 cm", rating: 4.70, current_wait_time: 0, total_queue_count: 0, status_label: "Open (0 min wait)", img: nitroImg },
  { id: 12, name: "Magic Carousel", emoji: "🎠", category: "family", thrill_level: 1, capacity: 40, duration: "6 min", zone: "Zone C", height: "None", rating: 4.30, current_wait_time: 0, total_queue_count: 0, status_label: "Open (0 min wait)", img: screamImg },
  { id: 13, name: "Chhota Bheem – The Ride", emoji: "👦", category: "kids", thrill_level: 1, capacity: 30, duration: "3 min", zone: "Zone D", height: "None", rating: 4.20, current_wait_time: 0, total_queue_count: 0, status_label: "Open (0 min wait)", img: spacexImg },
  { id: 14, name: "Elephant Ride", emoji: "🐘", category: "kids", thrill_level: 1, capacity: 30, duration: "5 min", zone: "Zone D", height: "None", rating: 4.10, current_wait_time: 0, total_queue_count: 0, status_label: "Open (0 min wait)", img: dropImg },
  { id: 15, name: "Mini Fall", emoji: "⬇️", category: "kids", thrill_level: 2, capacity: 30, duration: "4 min", zone: "Zone D", height: "None", rating: 4.30, current_wait_time: 0, total_queue_count: 0, status_label: "Open (0 min wait)", img: dinoImg },
  { id: 16, name: "Cinema 360 – Prince of the Dark Waters", emoji: "🎬", category: "kids", thrill_level: 2, capacity: 80, duration: "10 min", zone: "Zone D", height: "None", rating: 4.50, current_wait_time: 0, total_queue_count: 0, status_label: "Open (0 min wait)", img: nitroImg }
];
